...
public class InstructorCoursesPanel extends JPanel {
    ...
    public InstructorCoursesPanel(JPanel parentPanel, CardLayout cardLayout) {
        setLayout(null);
    ...
    private void setupBanner() {
        ...
        titleLabel.setBounds(75, 105, 300, 40);
    ...
    private void setupTable() {
        ...
        tablePanel.setBounds(25, 197, 1043, 464); // X, Y, WIDTH, LENGTH
        add(tablePanel);


        String[] columns = {"Course Code", "Course Description", "Units", "Number of Students"};
        Object[][] data = {
            {"CCS108", "Object-Oriented Programming", 3, 20},
            {"CCS110", "Information Management", 3, 49},
        };
        ...
        table.getColumnModel().getColumn(1).setMaxWidth(655);
        table.getColumnModel().getColumn(1).setMinWidth(525);
        ...
        table.getColumnModel().getColumn(3).setMaxWidth(335);
        table.getColumnModel().getColumn(3).setMinWidth(205);
    ...
    private void openCourseDetailPanel(String courseCode, String description) {
        ...
        if (existingPanel == null) {
            InstructorCourseViewPanel courseDetailPanel = new InstructorCourseViewPanel(parentPanel, cardLayout, courseCode, description);
    ...
    private class DeleteCourseButtonRenderer extends JButton implements TableCellRenderer {
        public DeleteCourseButtonRenderer() {
            setOpaque(true);
            setText("Delete");
    ...
    private class DeleteCourseButtonEditor extends DefaultCellEditor {
        private JButton button;
        private JTable table;

        public DeleteCourseButtonEditor(JCheckBox checkBox, JTable table) {
            super(checkBox);
            this.table = table;
            ...
            button.addActionListener(e -> {
                ...
                if (result == JOptionPane.YES_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(button, "Deleted course " + courseCode);
                }
            });
        }
