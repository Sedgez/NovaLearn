...
public class StudentNotificationsPanel extends JPanel {
    ...
    public StudentNotificationsPanel(JPanel parentPanel, CardLayout cardLayout) {
    ...
    private void setupNotifications() {
        ...
        addNotification("You have been enrolled in CCS108 - Object-Oriented Programming.");
        addNotification("Grades for CCS110 - Information Management are now available.");
        addNotification("Your course CCS105 - Fundamentals of Programming is about to start.");
    }
